<template>
  <div>
    ...
    <el-card>
      ...
      <!-- 步骤条区域 -->
      <!-- activeIndex - 0，是为了将字符串activeIndex变成数字类型 -->
      ...
      >
        ...
        >
          ...
          <el-tab-pane label="商品图片" name="3">
            <!-- action表示图片要上传到后台的api地址,此处需要写一个完整的API地址-->
            <el-upload
              :action="uploadURL"
...
export default {
  data() {
    return {
      ...
      // 图片上传组件的headers，因为upload没有使用我们自己封装的axios发起请求，报错“无效的token”，所以我们要用upload自带的属性手动指定请求头
      headerObj: {
  ...
  methods: {
    ...
    add() {
      ...
      this.$refs.addFormRef.validate((valid) => {
        ...
        // 执行添加商品的业务逻辑
        // lodash 提供了一个深拷贝方法 cloneDeep（obj）
