  ...
  <div>
    ...
    <el-card>
      ...
      <el-row class="cat_opt">
        <el-col>
          <span class="choseCateLable">选择商品分类：</span>
          <!-- 选择商品分类的级联选择框 -->
          <el-cascader
    ...
    <!-- 添加参数的对话框 -->
    <!-- 因为titleText是一个动态的，所以需要加上冒号进行动态绑定 -->
    <el-dialog
      :title="'添加' + titleText"
  ...
  methods: {
    ...
    async getParamsData() {
      ...
      res.data.forEach((item) => {
        ...
        // 控制文本框的显示与隐藏，这两行代码可以解决添加属性时，两行属性联动的效果
